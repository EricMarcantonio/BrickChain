...
const CANDIDATES = [
    {
        name: "Candidate A",
        party: "Party A",
        partyLeader: "Leader A",
        src:
            "https://images-platform.99static.com//JBUCJ4ZTzO2yShW2oVYEiB69DUc=/101x0:866x765/fit-in/500x500/99designs-contests-attachments/51/51405/attachment_51405319",
    },
    {
        name: "Candidate B",
        party: "Party B",
        partyLeader: "Leader B",
        src:
            "https://www.graphicsprings.com/filestorage/stencils/3378bef47673cbd31dd9a8c23ccf909d.png?width=500&height=500",
    },
    {
        name: "Candidate C",
        party: "Party C",
        partyLeader: "Leader C",
        src:
            "https://www.graphicsprings.com/filestorage/stencils/5dbb293a31960c27177152551937cdbf.png?width=500&height=500",
    },
    {
        name: "Candidate D",
        party: "Party D",
        partyLeader: "Leader D",
        src:
            "https://www.graphicsprings.com/filestorage/stencils/3378bef47673cbd31dd9a8c23ccf909d.png?width=500&height=500",
    },
    {
    ...
    return con.sumbitVote ? (
        ...
        <div className="container mx-auto">
            ...
            <div className="footer">
                <button onClick={handleReset} className="button-vote">
                    Reset
                </button>
